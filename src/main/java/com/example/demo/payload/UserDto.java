...
public class UserDto {
	...
	public UserDto(int i, String string, String string2, String email2, Date date2, boolean b) {
		// TODO Auto-generated constructor stub
	}
	public UserDto(int userId,
			...
			String about, String gender, Date date, boolean active, Set<RoleDto> roles, @NotBlank String phone) {
		super();
		this.userId = userId;
		this.name = name;
		this.email = email;
